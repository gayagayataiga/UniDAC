...
python demo/tools/grid_search_cam_params.py   # sweeps cam params when intrinsics are unknown
python demo/tools/sweep_GX010012_frame0.py    # finer-grained single-frame sweep used to lock Preset A
```
